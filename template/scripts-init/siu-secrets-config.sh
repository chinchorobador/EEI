...
generar_secrets(){
    ...
    # export REPORTES_DB_USERNAME=${POSTGRES_USERNAME}
    export REPORTES_DB_PASSWORD=${POSTGRES_PASSWORD}
    export SOLICITUDES_DB_PASSWORD=${POSTGRES_PASSWORD}
    ...
    export API_REPORTES_USERNAME=reportes
    export API_REPORTES_PASSWORD=$(eval ${PWDGEN})
    export API_SOLICITUDES_PASSWORD=$(eval ${PWDGEN})
    ...
    export REPORTES_JASPER_PASSWORD=$(eval ${PWDGEN})
